...
def main():
    try:
        ...
        arg_parser.add_argument(
            "--file", "-f", type=str, help="Paste from file")
        arg_parser.add_argument(
            "--title", "-t", type=str, help="Set Paste title")
        arg_parser.add_argument("--contents", "-c", type=str,
        ...
        arg_parser.add_argument(
            "-d", "--delete", type=str, help="Deletes a paste")
