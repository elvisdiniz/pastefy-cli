...
class Config:
    def __init__(self, config_path=None):
        ...
        self.config_path = config_path or os.path.expanduser("~/.config/pastefycli.json")
    ...
    def write_config(self, content):
        pathlib.Path(os.path.dirname(self.config_path)).mkdir(parents=True, exist_ok=True)
